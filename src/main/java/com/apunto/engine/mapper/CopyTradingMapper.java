    ...
    default OperationDto buildClosePosition(CopyOperationDto copyOperation, UserDetailDto userDetail) {
        ...
        if ("LONG".equals(copyOperation.getTypeOperation())) {
            return OperationDto.builder()
                    ...
                    .leverage(null)
                    .clientOrderId(IdempotencyKeyUtil.closeClientOrderId(copyOperation.getIdOrderOrigin(), userDetail.getUser().getId().toString(), copyOperation.getIdWalletOrigin(), copyOperation.getCopyStrategyCode()))
