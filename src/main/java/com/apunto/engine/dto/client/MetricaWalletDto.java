...
public class MetricaWalletDto {
    ...
    public static class RealJewelDto {
        ...
        private List<String> hardBlockers;
        private List<String> softWarnings;
        private List<String> dataWarnings;
        private List<String> capitalWarnings;
        private Map<String, Object> capitalDecision;
        private Map<String, Object> movementEvidence;
